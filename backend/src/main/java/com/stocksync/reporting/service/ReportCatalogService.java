...
public class ReportCatalogService {
    ...
    private final List<ReportDefinitionResponse> reports = List.of(
            ...
            def("SITE_OPERATIONS_REGISTER", "Site Operations Register", "Operations", TABULAR, opsViewer(), false, "Site transport, labor and site operation expenses."),
            ...
            def("INQUIRY_REGISTER", "Inquiry Register", "Commercial", TABULAR, commercialRoles(), false, "Client lead and inquiry register."),
