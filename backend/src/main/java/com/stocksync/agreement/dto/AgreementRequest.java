...
public record AgreementRequest(
 ...
 @NotNull @DecimalMin("0") BigDecimal securityDeposit,@Size(max=2000) String headerText,@Size(max=255) String partATitle,@Size(max=255) String partBTitle,@Size(max=4000) String terms,@Size(max=1000) String notes,
