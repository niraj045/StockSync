...
public class QuotationTemplateService {
    ...
    private void apply(QuotationTemplate t,QuotationTemplateRequest r){
        ...
        t.setDefaultPartATitle(trim(r.defaultPartATitle()));t.setDefaultPartAText(trim(r.defaultPartAText()));t.setDefaultPartBTitle(trim(r.defaultPartBTitle()));
    ...
    private QuotationTemplateResponse response(QuotationTemplate t){return new QuotationTemplateResponse(t.getId(),t.getTemplateCode(),t.getName(),t.getDescription(),
        t.getCompanyName(),t.getCompanyAddress(),t.getCompanyGstin(),t.getHeaderText(),t.getFooterText(),t.getDefaultPartATitle(),t.getDefaultPartAText(),t.getDefaultPartBTitle(),t.getDefaultTerms(),t.getDefaultNotes(),
