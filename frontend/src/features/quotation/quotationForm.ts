...
export type QuotationEditor = {
  ...
  securityDeposit: number; headerText?: string; partATitle?: string; partAText?: string; partBTitle?: string; terms?: string; notes?: string; items: QuotationItem[]; exactHire?: ExactHireFields; version?: number;
};
