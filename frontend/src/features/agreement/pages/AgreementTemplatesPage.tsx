...
export function AgreementTemplatesPage(){
 ...
 <Alert type="info" showIcon message="Imported PDFs become review drafts" description="StockSync extracts data locally without a paid AI API. A reviewed reference PDF does not generate agreements until a native layout or field mapping is completed."/>
